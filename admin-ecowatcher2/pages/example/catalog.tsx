...
function Catalog() {
  ...
  const saveChanges = async () => {
    ...
    closeModal();
    await fetchKatalogData(); // Refresh data setelah menyimpan
  };
        ...
        <div className="fixed inset-0 z-50 overflow-y-auto">
          <div className="flex items-center justify-center min-h-screen px-4">
            ...
            <div className="relative bg-white rounded-lg max-w-lg w-full p-6">
              <div className="flex justify-between items-center mb-4">
                <h3 className="text-lg font-medium">Edit Barang</h3>
                <button
                  onClick={closeModal}
                ...
                <div className="grid gap-4">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-lg">{detailsData.Type}</p>
                    </div>
                    <div>
                      <p className="text-sm font-medium">ID Barang</p>
                      <p className="text-lg">{detailsData.Id_barang}</p>
                    </div>
                  </div>
                </div>
              )}
      ...
      {isAddModalOpen && (
        <div className="fixed inset-0 z-50 overflow-y-auto">
          <div className="flex items-center justify-center min-h-screen px-4">
            ...
            <div className="relative bg-white rounded-lg max-w-lg w-full p-6">
              <div className="flex justify-between items-center mb-4">
                <h3 className="text-lg font-medium">Tambah Item Baru</h3>
                <button
