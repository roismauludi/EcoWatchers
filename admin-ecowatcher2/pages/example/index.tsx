            ...
            <div className="space-y-6">
              ...
              <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <p className="font-medium text-gray-900 dark:text-white">
                      {selectedPenyetoranDetail.address.No_tlp}
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
                ...
                <div className="grid grid-cols-1 gap-4">
                  ...
                  <div>
                    ...
                    <p className="font-medium text-gray-900 dark:text-white">
                      {selectedPenyetoranDetail.address.Detail_Alamat}
                    </p>
                  </div>
              ...
              <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <Badge type={getBadgeType(selectedPenyetoranDetail.status)}>
                  ...
                  <div>
                    ...
                    <p className="font-medium text-gray-900 dark:text-white">
                      {selectedPenyetoranDetail.queueNumber}
                    </p>
                  </div>
                  <div>
                    <p className="text-sm text-gray-500 dark:text-gray-200">
                  ...
                  <div>
                    ...
                    <p className="font-medium text-gray-900 dark:text-white">
                      {new Date(
                        selectedPenyetoranDetail.pickUpDate
                      ).toLocaleDateString("id-ID", {
                        day: "2-digit",
                        month: "long",
                        year: "numeric",
                  ...
                  <div>
                    ...
                    <p className="font-medium text-gray-900 dark:text-white">
                      Rp{" "}
                      {selectedPenyetoranDetail.pickUpFee.toLocaleString(
                        "id-ID"
                      )}
                    </p>
                  </div>
              ...
              <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
                ...
                <div className="space-y-4">
                  {selectedPenyetoranDetail.items?.map((item, index) => {
