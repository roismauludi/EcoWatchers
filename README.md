Ambil IP Address terlebih dahulu di cmd atau powershell dengan menggunakan ipconfig dan ambil IPv4 Address nya kemudian copy pada config.ts pada folder ecowatcher di dalam app/config.ts
